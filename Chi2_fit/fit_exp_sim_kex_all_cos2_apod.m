...
% Printing file
fileID = fopen('results_fit_exp_sim_kex_all_cos2_apod.txt','w');
...
datap(2,:)=proc_fid(data(2,:),100000,32768,20,78,-38,0,2,15900,67);
datap(3,:)=proc_fid(data(3,:),100000,32768,20,64,-38,0,2,15900,67);
datap(4,:)=proc_fid(data(4,:),100000,32768,20,210,-38,0,2,15900,67);
datap(5,:)=proc_fid(data(5,:),100000,32768,20,210,-38,0,2,15900,67);
datap(6,:)=proc_fid(data(6,:),100000,32768,20,210,-38,0,2,15900,67);
datap(7,:)=proc_fid(data(7,:),100000,32768,20,210,-38,0,2,15900,67);

...
datap=zeros(6,32768);
datap(1,:)=phase1(data(1,:),100000,32768,0,66,-38,0,0,15900,67);
datap(2,:)=phase1(data(2,:),100000,32768,0,210,-38,0,0,15900,67);
datap(3,:)=phase1(data(3,:),100000,32768,0,210,-38,0,0,15900,67);
datap(4,:)=phase1(data(4,:),100000,32768,0,62,-38,0,0,15900,67);
datap(5,:)=phase1(data(5,:),100000,32768,0,210,-38,0,0,15900,67);
datap(6,:)=phase1(data(6,:),100000,32768,0,210,-38,0,0,15900,67);
...
print -dpdf -fillpage figure_fit_no_apod.pdf
